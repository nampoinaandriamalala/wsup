...
function NumberToLetter(nombre)
{
    ...
    if(tab.length == 2)
    {
        var entier = parseInt(tab[0]);
        var decimale = parseInt(tab[1]);       
        
        return NumberToLetterSimple(entier) +' virgule '+ NumberToLetterSimple(decimale);
        
    } else {
      return  NumberToLetterSimple(nombre);
    }
}
function NumberToLetterSimple( nombre ){
